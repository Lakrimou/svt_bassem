...
class SectionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('SvtAdminBundle:section:index.html.twig', array(
            'sections' => $sections,
        ));
    }
    ...
    {
        $section = new Section();
        $form = $this->createForm('Svt\BassemBundle\Form\SectionType', $section);
        $form->handleRequest($request);

        if ($form->isSubmitted() && $form->isValid()) {
            $em = $this->getDoctrine()->getManager();

            $file = $section->getImgSection();
            ...
            $section->setImgSection($fileName);
            $date = new \DateTime();
        ...
        return $this->render('SvtAdminBundle:section:new.html.twig', array(
            'section' => $section,
    ...
    public function showAction(Section $section)
    {
        ...
        return $this->render('SvtAdminBundle:section:show.html.twig', array(
            'section' => $section,
    ...
    {
        $deleteForm = $this->createDeleteForm($section);
        $editForm = $this->createForm('Svt\BassemBundle\Form\SectionType', $section);
        ...
        return $this->render('SvtAdminBundle:section:edit.html.twig', array(
            'section' => $section,
